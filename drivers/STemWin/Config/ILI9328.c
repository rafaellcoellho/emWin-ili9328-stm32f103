...
void ILI9328_Init(void)
{
	...
	// HAL_Delay(50);
	// writeRegister(0x12, 0x013B);
	// HAL_Delay(50);
	// writeRegister(0x13, 0x1900);
	// writeRegister(0x29, 0x0007);
	// writeRegister(0x2B, 0x0020);
	// HAL_Delay(50);
	// writeRegister(0x20, 0x0000);
	// writeRegister(0x21, 0x0000);
        //
	// writeRegister(0x30, 0x0007);
	// writeRegister(0x31, 0x0504);
	// writeRegister(0x32, 0x0703);
	// writeRegister(0x35, 0x0002);
	// writeRegister(0x36, 0x0707);
	// writeRegister(0x37, 0x0406);
	// writeRegister(0x38, 0x0006);
	// writeRegister(0x39, 0x0404);
	// writeRegister(0x3C, 0x0700);
	// writeRegister(0x3D, 0x0A08);
        //
