...
void ILI9328_Test()
{
	...
	writeRegister(0x50, 0x0064);
	writeRegister(0x51, 0x0096);
	writeRegister(0x52, 0x0064);
	writeRegister(0x53, 0x0096);
	writeRegister(0x20, 0x0064);
	writeRegister(0x21, 0x0064);
